...
const Stats = () => (
    ...
    <section className={`${styles.flexCenter} flex-row flex-wrap sm:mb-20 mb-6 mt-[-20px]`}>
      
    {stats.map((stat)=>(
      <div key={stat.id} className={`flex-1 flex justify-start items-center flex-row ml-10 `}>
